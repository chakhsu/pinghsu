		...
		<?php while($this->next()): ?>
			...
			<div class="post-onelist-item">
				<div class="post-onelist-item-container">
					<a href="<?php $this->permalink(); ?>">
					<?php if (array_key_exists('thumb',unserialize($this->___fields()))): ?>
						<div class="onelist-item-thumb" style="background-image:url(<?php parseFieldsThumb($this);?>);"></div>
                    <?php else : ?>
                    <?php $thumb = showThumb($this,null,true);?>
                    <?php if(!empty($thumb)):?>
                    	<div class="onelist-item-thumb" style="background-image:url(<?php echo $thumb;?>);"></div>
                	<?php else : ?>
                		<div class="onelist-item-thumb" style="background-image:url(<?php $this->options->themeUrl('images/thumbs/'.mt_rand(0,9).'.jpg'); ?>);"></div>
                    <?php endif; ?>
					<?php endif; ?>
					</a>
