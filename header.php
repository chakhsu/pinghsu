...
<head>
    ...
    <meta name="apple-mobile-web-app-capable" content="yes"><?php if($this->options->favicon): ?>
    ...
    <link href="<?php $this->options->themeUrl('style.min.css?20170327'); ?>" rel="stylesheet">
    <!--[if lt IE 9]>
